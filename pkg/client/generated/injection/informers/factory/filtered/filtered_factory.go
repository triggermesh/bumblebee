...
import (
	...
	externalversions "github.com/triggermesh/bumblebee/pkg/client/generated/informers/externalversions"
...
func Get(ctx context.Context, selector string) externalversions.SharedInformerFactory {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panicf(
			"Unable to fetch github.com/triggermesh/bumblebee/pkg/client/generated/informers/externalversions.SharedInformerFactory with selector %s from context.", selector)
	}
