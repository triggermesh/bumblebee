...
import (
	...
	internalclientsetscheme "github.com/triggermesh/bumblebee/pkg/client/generated/clientset/internalclientset/scheme"
	client "github.com/triggermesh/bumblebee/pkg/client/generated/injection/client"
...
const (
	defaultControllerAgentName = "transformation-controller"
	defaultFinalizerName       = "transformations.flow.triggermesh.io"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	transformationInformer := transformation.Get(ctx)

	lister := transformationInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "flow.triggermesh.io.Transformation"),
	)
